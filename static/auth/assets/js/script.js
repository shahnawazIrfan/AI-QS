(function ($) {
    ...
    $('form button[type="submit"]').on('click', function () {
        ...
        $('.show-hide').parent().find('input[name="password1"]').attr('type', 'password');
    });

    $('.show-hide2').show();
    $('.show-hide2 span').addClass('show');

    $('.show-hide2 span').click(function () {
    ...
    $('form button[type="submit"]').on('click', function () {
        $('.show-hide2 span').addClass('show2');
        $('.show-hide2').parent().find('input[name="password2"]').attr('type', 'password');
    });
    ...
    .then((result) => {
        ...
        setTimeout(() => {
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    'name': user['displayName'].split(" ").join(""),
                    'email': user['email'],
                    'password': user['uid'],
                ...
                success: function(response) {
                    if(response.status == true){
                        ...
                        Snackbar.show({
                            text: "This email doesn't linked with your google account",
